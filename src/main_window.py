...
class NodeEditor(QWidget):
    ...
    def initUI(self):
        ...
        self.layoutG1.addWidget(self.theme_toggle, 0, 4, 1, 1, alignment=Qt.AlignmentFlag.AlignCenter)
        self.layoutG1.addWidget(self.settings_button, 1, 4, 1, 1, alignment=Qt.AlignmentFlag.AlignCenter)
